...
/// Number formatter.
final _formatter = NumberFormat('#,##0.0', "en_IN");
...
void __log(
  ...
  // Break if in release mode && showInReleaseMode is false:
  if (flutter.kReleaseMode && !_logger.showInReleaseMode) return;
