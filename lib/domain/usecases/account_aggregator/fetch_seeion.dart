...
@injectable
class FetchSeeion extends UseCase<ConsentStatusModel, NoParams> {
  final AccountAggregatorRepositories accountAggregatorRepositories;

  FetchSeeion(this.accountAggregatorRepositories);

  @override
  Future<Either<AppError, ConsentStatusModel>> call(NoParams params) async =>
      await accountAggregatorRepositories.getSessionStatus();
}
