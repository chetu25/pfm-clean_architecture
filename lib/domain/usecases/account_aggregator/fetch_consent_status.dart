...
@injectable
class FetchConsentStatus extends UseCase<ConsentStatusModel, NoParams> {
  final AccountAggregatorRepositories accountAggregatorRepositories;

  FetchConsentStatus(this.accountAggregatorRepositories);

  @override
  Future<Either<AppError, ConsentStatusModel>> call(NoParams params) async =>
      await accountAggregatorRepositories.getConsentStatus();
}
